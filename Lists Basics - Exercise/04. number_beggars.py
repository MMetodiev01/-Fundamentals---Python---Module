...
while starting_index < beggars:
    ...
    sum_for_beggar = 0
    # for the first beggar we start from our implement starting index_jumps and finish to length of our money list and with that we know
    ...
    # after the beggar finishes, we sum up our index_jumps to start the next beggar from the next position
    starting_index += 1
