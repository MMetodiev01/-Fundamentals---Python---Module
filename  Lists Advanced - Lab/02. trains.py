...
# · "insert {index_jumps} {people}" - you should add the number of people at the given wagon
# · "leave {index_jumps} {people}" - you should remove the number of people from the wagon.\
# There will be no case in which the people will be more than the count in the wagon.
# There will be no case in which the index_jumps is invalid!
